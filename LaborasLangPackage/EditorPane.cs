...
namespace LaborasLangPackage
{
    ...
    //     - An empty ll file in the same directory as NewFileItems.vsdir. In
    //       our case we chose LaborasLang Source File.ll. Note this file name appears in Editor.vsdir
    ...
    //          - "LaborasLang Source File" - This is the base file name. New files will initially
    //             be named as LaborasLang Source File1.ll, LaborasLang Source File2.ll... etc.
    ///////////////////////////////////////////////////////////////////////////////
    // Editor.vsdir contents:-
    //    LaborasLang Source File.ll|{3085E1D6-A938-478e-BE49-3546C09A1AB1}|#106|80|#109|0|401|0|#107
    //
    // The fields in order are as follows:-
    //    - LaborasLang Source File.ll - our empty ll file
                                ...
                                IVsToolboxUser      //Sends notification about Toolbox items to the owner of these items
    {
        ...
        private const string MyExtension = ".ll";
        ...
        #region Fields
        private LaborasLangPackagePackage myPackage;
        ...
        public EditorPane(LaborasLangPackagePackage package)
            : base(null)
        {
            PrivateInit(package);
        }
        ...
        /// <summary>
        /// Initialization routine for the Editor. Loads the list of properties for the ll document 
        /// which will show up in the properties window 
        /// </summary>
        /// <param name="package"></param>
        private void PrivateInit(LaborasLangPackagePackage package)
        {
            myPackage = package;
            loading = false;
        ...
        private void setupCommands()
        {
            ...
            if (null != mcs)
            {
                ...
                addCommand(mcs, GuidList.guidLaborasLangPackageCmdSet, (int)PkgCmdIDList.icmdStrike,
        ...
        private void DisplayContextMenuAt(Point point)
        {
            ...
            CommandID contextMenuID = new CommandID(GuidList.guidLaborasLangPackageCmdSet, PkgCmdIDList.IDMX_RTF);
        ...
        {
            pClassID = GuidList.guidLaborasLangPackageEditorFactory;
            return VSConstants.S_OK;
        }
